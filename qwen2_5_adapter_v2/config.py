...
class Qwen2AdapterV2Config(PretrainedConfig):
    r"""
    ...
    Args:
        ...
        add_bias (`bool`, *optional*, defaults to `False`):
            Whether to add bias to the adapter.
        add_scale (`bool`, *optional*, defaults to `False`):
            Whether to add scale to the adapter.
